        ...
        <div className="flex flex-col gap-y-10 lg:flex-row lg:items-center lg:gap-x-20 lg:gap-y-0">
          ...
          >
            ...
            <p className="mb-6">
              ...
              <a href="https://clarusway.com/" className="text-lime-500">
                Clarusway IT School
              </a>
              . I studied electronic & communication engineering before. I've
              been working on Frontend Development since July 2022 and Backend
